...
export default function NewsHome() {
  return (
    <section className="  flex w-full gap-10 mt-[60px] max-lg:block text-black">
        ...
        <article className="flex flex-col gap-[60px] w-full max-lg:w-full">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-[40px]">
              <h2 className="font-semibold bg-gray-200 text-black rounded-md px-4 py-2 cursor-pointer">
                All
              </h2>
